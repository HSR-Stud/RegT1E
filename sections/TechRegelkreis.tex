...
\subsection{Definitionen \skript{14}}
...
\begin{description}[leftmargin=2.5cm]
 ...
 \item[Prozess] Die Gesammtheit der zusammenwirkenden Vorgänge in einem System,
        		...
        		gespeichert wird.
 \item[Modell] Ein Modell ist eine graphische oder mathematische Abbildung bzw. Beschreibung
 				von Systemen zur Erklärung, Gestaltung, Prognose und Optimierung. Es muss
 				nicht unbedingt vollständig sein, jedoch hinreichend für die Fragestellung.
