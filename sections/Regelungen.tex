...
\subsection{Glieder}
	...
	\begin{tabular}{|l|l|l|l|l|l|}
    	...
    	\hline
    	\hline
    	\textbf{P-Glied} \skript{35} & $y(t)=K u(t)$	& K & K
	...
	\subsubsection{Zweipunktregler \skript{46}}
		\begin{minipage}{3cm}
		...
		Zweipunktregler mit symmetrischer Kennlinie \skript{52}
		\begin{minipage}{9cm}
			\vspace{.5cm}        
	...
	\hrule
	\vspace{.5cm}
		Zweipunktregler an ausgleichender Strecke \skript{53}
		\begin{minipage}{9cm}
    ...
    \subsubsection{Rückkopplung des Reglers \skript{57}}
		\begin{minipage}{9cm}
	...
	\subsubsection{Dreipunktregler \skript{59}}
		\begin{minipage}{9cm}
