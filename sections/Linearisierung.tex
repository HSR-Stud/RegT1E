\section{Linearisierung \skript{76}}
	\begin{multicols}{2}
		\subsection{LTI-Systeme \skript{83}}
		...
		\columnbreak
			...
			\includegraphics{bilder/linearitaetstest}
		\end{multicols}
	  	
	\subsection{Erwünschte Nichtlinearität \skript{84}}
	...
	\begin{minipage}[c]{8cm}
		...
		- Integration \\
		- Differentiation \\
		und daraus folgt, dass folgende Glieder auch linear sind: \\
		- P-Glied \\
		- I-Glied \\
		- PT1-Glied
	\end{minipage}
	...
	\subsubsection{Messung einer statischen Kennlinie \skript{86}}
	\begin{minipage}{10cm}
	...
	\subsubsection{Mathematische Erfassung einer Messkurve \skript{89}}
	...
	\subsection{Linearisierung}
		\subsubsection{Modelleinschränkung \skript{92}}
		...
		\subsubsection{Arbeitspunkt \skript{93}}
		...
		\subsubsection{Durch inverse Kennlinie \skript{94}}
		\begin{minipage}{11cm}
